...
class CreateLeadSheet extends HookConsumerWidget {
  final LeadEntity? lead;

  const CreateLeadSheet({super.key, this.lead});
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final _key = useMemoized(GlobalKey.new, const []);
    final lead = useState(LeadParam());
            ...
            Flexible(
              child: ListView(
                ...
                children: [
                  ElevatedCard(
                    child: Column(
                      ...
                      children: [
                          ...
                          children: [
                            RadioListTile.adaptive(
                              ...
                              groupValue: VendorType.values
                                  .elementAt(lead.value.type ?? 0),
                              onChanged: (v) =>
                                  lead.value = lead.value.copyWith(
                                type: v?.index,
                              ),
                            ),
                            RadioListTile.adaptive(
                        ...
                        Column(
                          children: [
                            if (lead.value.type == VendorType.Company.index)
                              CustomTextFormField(
                                isRequired: true,
                                labelText: context.l10n.kCompanyName,
                                value: lead.value.companyName,
                                onChanged: (value) =>
                                    lead.value = lead.value.copyWith(
                                  companyName: value,
                                ),
                              ),
                            if (lead.value.type == VendorType.Individual.index)
                              Column(
                                children: [
                                  CustomTextFormField(
                                    isRequired: true,
                                    labelText: context.l10n.kFirstName,
                                    value: lead.value.firstName,
                                    onChanged: (v) =>
                                        lead.value = lead.value.copyWith(
                                      firstName: v,
                                    ),
                        ...
                        // CurrencyBuilder(
                        //   onSelected: (v) => lead.value = lead.value.copyWith(
                        //     currencyId: v.id,
                        //   ),
                        // ),
                        CustomTextFormField(
                          ...
                          onChanged: (v) => lead.value = lead.value.copyWith(
                            email: v,
                          ),
                        ),
                        CustomTextFormField(
                  ...
                  //       // CreateContact(
                  //       //   onContactSelected:
                  //       //       context.read<CreateLeadCubit>().setContact,
                  //       // ),
                  //     ),
                  //     child: Icon(
                  //       Icons.add,
                  ...
                  //       // LedgerBuilder(
                  //       //   onSelected:
                  //       //       context.read<CreateLeadCubit>().setLedger,
                  //       // ),
                  ...
                  //       //   onChanged:
                  //       //       context.read<CreateLeadCubit>().setInactive,
                  //       // ),
                  //       // CheckboxListTile.adaptive(
                  //       //   contentPadding: EdgeInsets.zero,
                  //       //   title: Text(
                  ...
                  //       //   onChanged:
                  //       //       context.read<CreateLeadCubit>().setIsBanned,
                  //       // ),
                  //     ],
                  //   ),
                  // ),
