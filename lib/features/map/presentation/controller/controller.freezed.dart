...
extension MapViewStatePatterns on MapViewState {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(CameraPosition cameraPosition, Set<Marker> markers,
            Set<ExtendedPolyline> polylines, MapType mapType, bool isDragging)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _MapViewState() when $default != null:
        return $default(_that.cameraPosition, _that.markers, _that.polylines,
            _that.mapType, _that.isDragging);
      case _:
        return orElse();
    }
  }
