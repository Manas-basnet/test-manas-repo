...
/// Adds pattern-matching-related methods to [AgeingReportState].
extension AgeingReportStatePatterns on AgeingReportState {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_AgeingReportState value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _AgeingReportState() when $default != null:
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(List<AgeingReport> ageingReports)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _AgeingReportState() when $default != null:
        return $default(_that.ageingReports);
      case _:
        return orElse();
    }
  }
...
/// Adds pattern-matching-related methods to [FilterAgeingState].
extension FilterAgeingStatePatterns on FilterAgeingState {
  /// A variant of `map` that fallback to returning `orElse`.
  ///
  /// It is equivalent to doing:
  /// ```dart
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_FilterAgeingState value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _FilterAgeingState() when $default != null:
        return $default(_that);
      case _:
        return orElse();
    }
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(DateTime asOfDate, BaseOn baseOn, int daysPeriods,
            int columns, CustomerEntity? customer)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _FilterAgeingState() when $default != null:
        return $default(_that.asOfDate, _that.baseOn, _that.daysPeriods,
            _that.columns, _that.customer);
      case _:
        return orElse();
    }
  }
