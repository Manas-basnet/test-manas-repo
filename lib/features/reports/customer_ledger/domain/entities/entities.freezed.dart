...
/// Adds pattern-matching-related methods to [CustomerLedgerEntity].
extension CustomerLedgerEntityPatterns on CustomerLedgerEntity {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_CustomerLedgerEntity value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _CustomerLedgerEntity() when $default != null:
    ...
    switch (_that) {
      case _CustomerLedgerEntity() when $default != null:
        return $default(
            ...
            _that.credit,
            _that.balance,
            _that.isOpeningBalance,
            _that.isClosingBalance);
      case _:
        return orElse();
    }
  }
