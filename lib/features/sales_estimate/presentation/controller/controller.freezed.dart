...
/// Adds pattern-matching-related methods to [SalesEstimateState].
extension SalesEstimateStatePatterns on SalesEstimateState {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_SalesEstimateState value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _SalesEstimateState() when $default != null:
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(List<SalesEstimateEntity> salesEstimates, int count)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _SalesEstimateState() when $default != null:
        return $default(_that.salesEstimates, _that.count);
      case _:
        return orElse();
    }
  }
