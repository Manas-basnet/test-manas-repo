...
class SalesEstimateHistoryTabView extends HookConsumerWidget {
  const SalesEstimateHistoryTabView({
    Key? key,
    required this.salesEstimateId,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final systemInfoParam = SystemInfoParams(
      entityRefId: salesEstimateId,
      entityType: EntityType.Estimate.index,
    );
