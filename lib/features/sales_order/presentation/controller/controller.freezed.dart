...
extension SalesOrderStatePatterns on SalesOrderState {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_SalesOrderState value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(List<SalesOrderEntity> salesOrders, int count)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _SalesOrderState() when $default != null:
        return $default(_that.salesOrders, _that.count);
      case _:
        return orElse();
    }
  }
