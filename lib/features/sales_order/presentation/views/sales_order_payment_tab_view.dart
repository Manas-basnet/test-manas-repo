...
class SalesOrderTxnsTabView extends HookConsumerWidget {
  const SalesOrderTxnsTabView(this.salesOrderId, {super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final relatedRecordParam = RelatedRecordParams(
      id: salesOrderId,
      path: ApiEndpoints.kRelatedRecordSalesOrder,
    );
