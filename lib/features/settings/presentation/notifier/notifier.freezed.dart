...
mixin _$SettingsState {
  ...
  @override
  String toString() {
    return 'SettingsState(status: $status, locale: $locale)';
  }
}
...
abstract mixin class $SettingsStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({SettingsStatus status, Locale locale});
}
...
extension SettingsStatePatterns on SettingsState {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(SettingsStatus status, Locale locale)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _SettingsState() when $default != null:
        return $default(_that.status, _that.locale);
      case _:
        return orElse();
    }
  }
...
class _SettingsState implements SettingsState {
  const _SettingsState(
      {this.status = SettingsStatus.initial, this.locale = const Locale('en')});
