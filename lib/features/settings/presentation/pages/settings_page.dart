...
class SettingsPage extends HookConsumerWidget with CustomExpansionTrailing {
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              // Manas Addition - shorebird update check
              _buildAppManagementCard(context, ref),
  ...
  //Manas Addition - shorebird update check
  Widget _buildAppManagementCard(BuildContext context, WidgetRef ref) {
    return Card(
      child: Column(
        children: [
          _buildListTile(
            ...
            onTap: () async {
              ...
              ref.read(shorebirdUpdateNotifierProvider.notifier).checkForUpdates();
            },
