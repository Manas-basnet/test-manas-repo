...
class _UpdateBottomSheet extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ref.listen<ShorebirdUpdateState>(
      ...
      (previous, current) {
        if (current.status == AppUpdateStatus.downloaded) {
    ...
    final state = ref.watch(shorebirdUpdateNotifierProvider);
  ...
  Widget _buildActionButtons(BuildContext context, WidgetRef ref, ShorebirdUpdateState state) {
    switch (state.status) {
          ...
          children: [
            Expanded(
              child: OutlinedButton(
                onPressed: () {
                  ref.read(shorebirdUpdateNotifierProvider.notifier).dismissUpdate();
                  Navigator.of(context).pop();
                },
            ...
            Expanded(
              child: ElevatedButton(
                onPressed: () => ref.read(shorebirdUpdateNotifierProvider.notifier).downloadUpdate(),
